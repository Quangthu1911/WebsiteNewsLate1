			...
			<div class="row">
				...
				<c:forEach var="task" items="${firstNews}">
					<div class="blog-grid-top">
						...
						<c var="dt" items="dt">
							<div class="blog_info_left_grid">
								<a href="readDetail?idfirstnews=${task.iddetailnews}">
									<img width="1000px" class="img-fluid" src="getPhoto/<c:out value='${task.iddetailnews}'/>">
								</a>
							</div>
							</c>
						...
						<h3>
							<a href="readDetail?idfirstnews=${task.iddetailnews}">${task.title}</a>
						</h3>
						<p>${task.quote}</p>
							...
							<div class="col-md-6 blog-grid-top">
								<div class="b-grid-top">
									...
									<div class="blog_info_left_grid tech-btm">
										<a href="readDetail?idfirstnews=${task.iddetailnews}">
											<img class="img-fluid" width="1000px" src="getPhoto/<c:out value='${task.iddetailnews}'/>">
										</a>
									</div>
